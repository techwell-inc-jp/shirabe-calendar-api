...
export const ROKUYO_NOTES: Record<RokuyoType, Partial<Record<Category, string>>> = {
  大安: {
    wedding: "大安は終日吉で結婚式に最適な日",
    funeral: "大安は慶事向きの日で葬儀には不向きな日",
    moving: "大安は万事に良く引っ越しにも適した日",
  ...
  友引: {
    wedding: "友引は慶事に良い日",
    funeral: "友引は「友を引く」とされ葬儀を避けるべき日",
    moving: "友引は引っ越しに問題のない日",
    construction: "友引は建築に問題のない日",
    business: "友引は契約・開業に問題のない日",
    car_delivery: "友引は納車に問題のない日",
    marriage_registration: "友引は入籍に良い日",
    travel: "友引は旅行出発に問題のない日",
  },
  先勝: {
    wedding: "先勝は午前中が吉で午前の式が望ましい日",
    funeral: "先勝は葬儀に特に問題のない日",
    construction: "先勝は午前の着工が良い日",
    business: "先勝は午前中の契約・開業が吉の日",
  },
  先負: {
    wedding: "先負は午後が吉で午後の式なら問題のない日",
    funeral: "先負は葬儀に特に問題のない日",
    business: "先負は午後の契約が良い日",
  },
  赤口: {
    wedding: "赤口は正午のみ吉で結婚式は避けた方が無難な日",
    funeral: "赤口は葬儀に大きな問題のない日",
    construction: "赤口は建築にはやや不向きな日",
    business: "赤口は正午のみ吉で契約は昼頃が良い日",
  },
  仏滅: {
    wedding: "仏滅は結婚式を避けるのが一般的な日",
    funeral: "仏滅は葬儀には問題のない日",
    moving: "仏滅は引っ越しを避けた方が無難な日",
    construction: "仏滅は着工・上棟を避けるのが一般的な日",
    business: "仏滅は開業・契約を避けた方が無難な日",
    car_delivery: "仏滅は納車を避ける人が多い日",
    marriage_registration: "仏滅は入籍を避けるのが一般的な日",
    travel: "仏滅は旅行出発にやや不向きな日",
  },
};
