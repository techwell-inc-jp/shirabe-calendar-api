...
export const DOCS_SITEMAP_PAGES: ReadonlyArray<SitemapDocEntry> = [
  ...
  { loc: "https://shirabe.dev/topics/nijushi-sekki", priority: "0.9", changefreq: "monthly" },
  {
  ...
  { loc: "https://shirabe.dev/docs/text-tokenize", priority: "0.9", changefreq: "monthly" },
  { loc: "https://shirabe.dev/docs/text-normalize", priority: "0.9", changefreq: "monthly" },
  { loc: "https://shirabe.dev/docs/text-furigana", priority: "0.9", changefreq: "monthly" },
  { loc: "https://shirabe.dev/docs/text-name-split", priority: "0.9", changefreq: "monthly" },
  { loc: "https://shirabe.dev/docs/text-name-reading", priority: "0.9", changefreq: "monthly" },
  { loc: "https://shirabe.dev/docs/text-pricing", priority: "0.8", changefreq: "monthly" },
  {
    loc: "https://shirabe.dev/announcements/2026-05-18",
    priority: "0.8",
    changefreq: "monthly",
  },
  {
    loc: "https://shirabe.dev/api/v1/text/openapi.yaml",
    priority: "0.9",
    changefreq: "monthly",
  },
  {
    loc: "https://shirabe.dev/api/v1/text/openapi-gpts.yaml",
    priority: "0.7",
    changefreq: "monthly",
  },
  { loc: "https://shirabe.dev/api/v1/text/llms.txt", priority: "0.7", changefreq: "weekly" },
  {
    loc: "https://shirabe.dev/api/v1/text/llms-full.txt",
    priority: "0.7",
    changefreq: "weekly",
  },
  { loc: "https://shirabe.dev/pricing", priority: "0.8", changefreq: "monthly" },
