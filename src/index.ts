...
app.get("/llms.txt", (c) => {
  const body = [
    ...
    "",
    "Shirabe Calendar API は以下の MCP registry に登録・公開済 (claim 済):",
    "",
    "- **Glama.ai**: <https://glama.ai/mcp/servers/techwell-inc-jp/shirabe-calendar-api>",
    ...
    "",
    "住所 API (Shirabe Address API) は MCP 未実装のため registry 登録対象外。",
    "2026-05-01 リリース後に MCP サーバー化した時点で追加 submit を検討。",
    "",
